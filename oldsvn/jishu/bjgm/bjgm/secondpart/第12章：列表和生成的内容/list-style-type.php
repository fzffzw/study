...
<title>12.1.1 列表样式类型：list-style-type属性 :: 12.1列表 :: 第12章：列表和生成的内容</title>
...
<h1>第12章：列表和生成的内容</h1>
<h2>12.1列表</h2>
<h3>12.1.1 列表样式类型：list-style-type属性</h3>
<h4>CSS 2.1 关键字：符号类</h4>
<ul id="type1">
  <li>disc</li>
  <li>disc</li>
  <li>disc</li>
...
<h4>CSS 2.1 关键字：无标记</h4>
<ul id="type15">
  <li>none</li>
  <li>none</li>
  <li>none</li>
</ul>
<h4>CSS 2.1未包含的CSS 2关键字</h4>
<ul id="type16">
  <li>hebrew</li>
  <li>hebrew</li>
  <li>hebrew</li>
