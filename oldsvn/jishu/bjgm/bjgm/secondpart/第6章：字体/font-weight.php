...
<title>6.3 字体磅值：font-weight属性 :: 第6章：字体</title>
...
<body id="c_font">
<h1>第六章：字体</h1>
<h2>6.3 字体磅值：font-weight属性</h2>
<div id="fontWeight">
  <h3><a name="inherited">font-weight的继承</a></h3>
  <p>段落中的<em>em中的<a href="#">链接</a>继承font-weight</em></p>
</div>
<div id="fontWeight2">
  <h3><a name="weight">font-weight, Arial</a></h3>
  ...
  <p class="w200">font-weight : 200</p>
  <p class="w300">font-weight : 300</p>
  <p class="w400">font-weight : 400</p>
  <p class="w500">font-weight : 500</p>
  <p class="w600">font-weight : 600</p>
  <p class="w700">font-weight : 700</p>
  <p class="w800">font-weight : 800</p>
