...
padding:4px;
margin:-4px 0 0 -4px;
background:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="../img/shadow.png", sizingMethod="crop");
_margin:0;
}
...
<div id="header">
  ...
  <div id="controlMenu">
    <ul>
      ...
      <li><a href="/member/score/" title="积分奖励内容查询">积分奖励
        <!--[if IE 7]><!-->
        </a>
        <!--<![endif]-->
        <div>
      ...
      <li><a href="/member/info/" title="修改个人信息">个人信息
        <!--[if IE 7]><!-->
        </a>
        <!--<![endif]-->
        <div>
      ...
      <li><a href="/member/orderForm/0" title="会员订单查询管理">订单管理
        <!--[if IE 7]><!-->
        </a>
        <!--<![endif]-->
        <div>
